...
# 设置 w2v 虚拟环境的路径
venv_path = "e:\annaconda\envs\w2v"
...
# 修复 requests.exceptions.ProxyError 问题
try:
    from requests.exceptions import ProxyError
except ImportError:
    # 如果不存在 ProxyError，定义一个假的
...
class ModelInference:
    def __init__(self, model_path='Qwen/Qwen1.5-0.5B-Chat'):
